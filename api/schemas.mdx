---
title: "Simplex Optimizer API – Request and Response Schemas"
...
<ResponseField name="midpoint" type="float" required>
  Midpoint `m = (a + b) / 2` evaluated in this step.
</ResponseField>

<ResponseField name="f_mid" type="float" required>
  Objective function value `f(m)` at the midpoint.
</ResponseField>

<ResponseField name="df_mid" type="float" required>
...
<ResponseField name="gradient" type="list[float]" required>
