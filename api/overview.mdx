---
title: "Simplex Optimizer REST API Overview"
sidebarTitle: "Overview"
description: "The Simplex Optimizer REST API provides nine solver endpoints under /api/v1. No authentication required. All endpoints accept and return JSON."
---
...
The table below lists all 14 endpoints exposed by the API.
