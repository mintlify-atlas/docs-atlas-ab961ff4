...
description: "Optimize a single-variable polynomial using Newton-Raphson on f′(x). Provide an initial guess x₀; converges quadratically to the nearest critical point."
---
