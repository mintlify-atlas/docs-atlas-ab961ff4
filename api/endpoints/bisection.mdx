...
description: "Optimize a single-variable polynomial over a closed interval using the Bisection method on f′(x). Returns the optimal point, its nature, and a full iteration table."
---
