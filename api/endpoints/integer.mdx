...
description: "Solve pure integer programs with 2–5 variables via Branch & Bound. All variables must be non-negative integers. Returns the optimal solution and B&B tree."
---
