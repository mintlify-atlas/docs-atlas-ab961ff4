...
description: "Solve nonlinear constrained problems with 2–3 variables and up to 5 constraints via KKT conditions. Reports all explored cases and the best feasible point."
---
