---
title: "Get Started with Simplex Optimizer in 5 Minutes"
sidebarTitle: "Quickstart"
description: "Learn how to run the Simplex Optimizer backend and frontend locally and make your first API call to solve a linear programming problem."
---
...
<Tip>
  You can explore and test all nine solver endpoints interactively through the Swagger UI at `http://localhost:8000/docs`. Each endpoint includes schema documentation and a built-in "Try it out" form.
</Tip>
...
- Read the [API Reference](/api/overview) for full schema documentation on all nine solvers.
