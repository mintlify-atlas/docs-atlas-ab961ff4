---
title: "Bisection Method for Single-Variable Polynomial Optimization"
sidebarTitle: "Bisection"
description: "Optimize a single-variable polynomial by bisecting its derivative f′(x) to zero. Supply coefficients, an interval, tolerance, and an optimization goal."
---
