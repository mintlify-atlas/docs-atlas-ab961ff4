...
<Note>
  For a pure quadratic like −x² + 4x, Newton-Raphson converges **exactly in one step** because the Newton correction is itself exact. For higher-degree polynomials, multiple iterations are generally required.
</Note>
