---
title: "Pure Integer Programming via Branch and Bound"
sidebarTitle: "Pure Integer"
description: "Solve general integer programs with 2–5 non-negative integer variables using Branch and Bound with dynamic lower and upper bounds at each node."
---
...
2. **Prune by bound** — if the LP objective at a node is no better than the current best integer solution, the subtree is discarded.
3. **Prune by infeasibility** — if the LP relaxation at a node is infeasible or unbounded, the subtree is discarded.
