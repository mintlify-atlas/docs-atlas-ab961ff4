---
title: "Binary Integer Programming via Branch and Bound"
...
<ResponseField name="message" type="string">
  Human-readable summary, e.g. `"Optimal solution found with Z = 22.0. Nodes explored: 5."`.
</ResponseField>
...
```json
{
  ...
  "message": "Optimal solution found with Z = 22.0. Nodes explored: 5."
}
```
