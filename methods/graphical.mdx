---
title: "Graphical Method for 2-Variable Linear Programs"
sidebarTitle: "Graphical LP"
description: "Visualize the feasible region, constraint lines, and optimal point for 2-variable linear programs. Automatically generated when using the Simplex solver with 2 variables."
---
...
```json
{
  ...
  "graphical": {
    "status": "optimal",
    "goal": "max",
    "bounds": { "x_min": 0.0, "x_max": 4.6, "y_min": 0.0, "y_max": 3.45 },
    "constraints": [
      {
        "a": 6.0, "b": 4.0, "c": 24.0,
      ...
      {
        "a": 1.0, "b": 2.0, "c": 6.0,
        "points": [{ "x": 0.0, "y": 3.0 }, { "x": 4.6, "y": 0.0 }],
        "label": "c2",
        "inequality": "<="
      }
    ],
